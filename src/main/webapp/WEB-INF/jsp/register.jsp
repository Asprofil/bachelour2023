        ...
        <div class="card-body">
            ...
            <form:form action="/register" class="reg-form" modelAttribute="registerUser">
                ...
                <div class="row">
                    ...
                    <!-- From Group -->
                    <div class="form-group col">
                        <input type="password" name="confirm_password" class="form-control form-control-lg" placeholder="Confirm"/>
            ...
            <p class="card-text text-white my-2">
                Already have an account? <span class="ms-2"><a href="/login" class="btn bt-sm text-warning">Login</a></span>
            </p>
            <!-- Card Text -->
